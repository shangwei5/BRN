...
parser.add_argument("--outf", type=str, default="logs/BRN-RX/R100H", help='path of log files')
...
def main():
    ...
    net = Generator_prelstminter11(recurrent_iter=opt.inter_iter, use_GPU=opt.use_GPU)
