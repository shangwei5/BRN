...
def main():
    ...
    # state_dict = torch.load(os.path.join(opt.logdir, 'net_epoch10.pth'))
    ...
    # torch.load(os.path.join(opt.logdir, 'net_latest.pth'))
    # torch.save(model.state_dict(), os.path.join(opt.logdir, 'net_latest1.pth'))
