...
gt_path='/media/r/dataset/rain/Rain100H/';

BRN = '../result/BRN/R100H/output/';
BRNRX = '../result/BRN-RX/R100H/output/';
BRNXR = '../result/BRN-XR/R100H/output/';
CRN = '../result/CRN/R100H/output/';
