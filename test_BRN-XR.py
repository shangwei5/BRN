...
parser.add_argument("--save_path_r", type=str, default="result/BRN-XR/R100H/rainstreak", help='path to save rain streaks')
...
def main():
    ...
    model = Generator_prelstminter33(opt.inter_iter, opt.use_GPU)
    print_network(model)
    if opt.use_GPU:
        model = model.cuda()
