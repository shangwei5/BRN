...
from generator import Generator_prelstminter11, print_network
import time

#os.environ["CUDA_DEVICE_ORDER"] = "PCI_BUS_ID"


parser = argparse.ArgumentParser(description="BRN-RX_Test")
parser.add_argument("--logdir", type=str, default="logs/BRN-RX/R100H", help='path of log files')
parser.add_argument("--data_path", type=str, default="dataset/...", help='path to testing data')
parser.add_argument("--save_path", type=str, default="result/BRN-RX/R100H/output", help='path to save results')
parser.add_argument("--save_path_r", type=str, default="result/BRN-RX/R100H/rainstreak", help='path to save rain streaks')
...
def main():
    ...
    model = Generator_prelstminter11(opt.inter_iter, opt.use_GPU)
    print_network(model)
    if opt.use_GPU:
        model = model.cuda()
